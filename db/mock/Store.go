...
// Source: github.com/KHarshit1203/simple-bank/db/gen (interfaces: Store)
...
// PurgeUserAccounts mocks base method.
func (m *MockStore) PurgeUserAccounts(arg0 context.Context, arg1 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PurgeUserAccounts", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// PurgeUserAccounts indicates an expected call of PurgeUserAccounts.
func (mr *MockStoreMockRecorder) PurgeUserAccounts(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PurgeUserAccounts", reflect.TypeOf((*MockStore)(nil).PurgeUserAccounts), arg0, arg1)
}
